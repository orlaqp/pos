...
import { processAspectRatio, processBoxShadowNative, processColor, processFilter, processFontWeight, processGap, processInset, processInsetBlock, processInsetInline, processTransform, processTransformOrigin } from './processors';
const colorAttributes = {
  process: processColor
};
export const BASE_PROPERTIES_CONFIG = {
  ...
  right: true,
  inset: {
    process: processInset
  },
  insetBlock: {
    process: processInsetBlock
  },
  insetInline: {
    process: processInsetInline
  },
  // TODO - check if these props should depend on layout direction
  insetBlockStart: {
    as: 'top'
  ...
  boxShadow: {
    process: processBoxShadowNative
  },
  // BORDERS
  // Radius
  borderRadius: true,
  ...
  experimental_backgroundPosition: false,
  // TODO
  // @ts-ignore This type doesn't exist on non-strict-api
  experimental_backgroundSize: false,
  // TODO
  // @ts-ignore This type doesn't exist on non-strict-api
  experimental_backgroundRepeat: false,
  // TODO
