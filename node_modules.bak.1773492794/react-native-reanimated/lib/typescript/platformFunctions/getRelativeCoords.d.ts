 ...
 */
export declare function getRelativeCoords<TRef extends InternalHostInstance>(animatedRef: AnimatedRef<TRef>, absoluteX: number, absoluteY: number): ComponentCoords | null;
