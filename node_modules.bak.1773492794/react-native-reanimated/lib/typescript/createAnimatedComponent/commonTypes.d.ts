...
export type AnimatedComponentTypeInternal = Component & IAnimatedComponentInternal;
export type PropUpdates = StyleProps | AnimatedStyle<any>;
export interface IPropsFilter {
    filterNonAnimatedProps: (component: AnimatedComponentTypeInternal) => Record<string, unknown>;
}
