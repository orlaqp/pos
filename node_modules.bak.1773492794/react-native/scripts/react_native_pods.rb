...
def use_react_native! (
  ...
  Pod::UI.puts "Configuring the target with #{new_arch_enabled ? "the New Architecture" : "the Legacy Architecture"}\n"
  ...
  setup_fabric!(:react_native_path => prefix) if fabric_enabled
  setup_bridgeless!(:react_native_path => prefix, :use_hermes => hermes_enabled) if new_arch_enabled
