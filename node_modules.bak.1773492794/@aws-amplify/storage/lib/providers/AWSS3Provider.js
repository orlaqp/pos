...
var AWSS3Provider = /** @class */ (function () {
    ...
    AWSS3Provider.prototype.startResumableUpload = function (addTaskInput, config) {
        ...
        var prefixPromise = core_1.Credentials.get().then(function (credentials) {
            ...
            return S3ClientUtils_1.getPrefix(__assign(__assign({}, config), { credentials: cred }));
        });
        ...
        StorageUtils_1.dispatchStorageEvent(track, 'upload', { method: 'put', result: 'success' }, null, "Upload Task created successfully for " + key);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        _c.sent();
                        StorageUtils_1.dispatchStorageEvent(track, 'copy', {
                            method: 'copy',
                            result: 'success',
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        StorageUtils_1.dispatchStorageEvent(track, 'download', { method: 'get', result: 'success' }, {
                            fileSize: Number(response.Body['size'] || response.Body['length']),
                        }, "Download success for " + key);
                        return [2 /*return*/, response];
                    case 4:
                        error_2 = _b.sent();
                        StorageUtils_1.dispatchStorageEvent(track, 'download', {
                            method: 'get',
                            result: 'failed',
                    ...
                    case 7:
                        ...
                        StorageUtils_1.dispatchStorageEvent(track, 'getSignedUrl', { method: 'get', result: 'success' }, null, "Signed URL: " + url);
                        return [2 /*return*/, url];
                    case 8:
                        error_3 = _b.sent();
                        logger.warn('get signed url error', error_3);
                        StorageUtils_1.dispatchStorageEvent(track, 'getSignedUrl', { method: 'get', result: 'failed' }, null, "Could not get a signed URL for " + key);
                        throw error_3;
    ...
    AWSS3Provider.prototype.put = function (key, object, config) {
        ...
        if (resumable === true) {
            ...
            s3Client.middlewareStack.add(S3ClientUtils_1.createPrefixMiddleware(opt, key), S3ClientUtils_1.prefixMiddlewareOptions);
            var addTaskInput = {
                bucket: bucket,
                key: key,
                s3Client: s3Client,
        ...
        try {
            ...
            return uploader.upload().then(function (response) {
                ...
                StorageUtils_1.dispatchStorageEvent(track, 'upload', { method: 'put', result: 'success' }, null, "Upload success for " + key);
                return { key: key };
            });
        }
        catch (error) {
            logger.warn('error uploading', error);
            StorageUtils_1.dispatchStorageEvent(track, 'upload', { method: 'put', result: 'failed' }, null, "Error uploading " + key);
            throw error;
        }
    };
    /**
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        response = _a.sent();
                        StorageUtils_1.dispatchStorageEvent(track, 'delete', { method: 'remove', result: 'success' }, null, "Deleted " + key + " successfully");
                        return [2 /*return*/, response];
                    case 4:
                        error_4 = _a.sent();
                        StorageUtils_1.dispatchStorageEvent(track, 'delete', { method: 'remove', result: 'failed' }, null, "Deletion of " + key + " failed with " + error_4);
                        throw error_4;
                    case 5: return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        s3 = this._createNewS3Client(opt);
                        listObjectsV2Command = new client_s3_1.ListObjectsV2Command(__assign({}, params));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 8:
                        ...
                        _a.label = 9;
                    case 9:
                        StorageUtils_1.dispatchStorageEvent(track, 'list', { method: 'list', result: 'success' }, null, list.length + " items returned from list operation");
                        logger.debug('list', list);
                        return [2 /*return*/, list];
                    case 10:
                        error_5 = _a.sent();
                        logger.warn('list error', error_5);
                        StorageUtils_1.dispatchStorageEvent(track, 'list', { method: 'list', result: 'failed' }, null, "Listing items failed: " + error_5.message);
                        throw error_5;
