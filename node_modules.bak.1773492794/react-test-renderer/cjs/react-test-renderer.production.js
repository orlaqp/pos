/**
 * @license React
 * react-test-renderer.production.js
 *
...
function scheduleTaskForRootDuringMicrotask(root, currentTime) {
  ...
  expirationTimes =
    null !== root.cancelPendingCommit || -1 !== root.timeoutHandle;
  suspendedLanes =
    root === (5 === pendingEffectsStatus ? pendingEffectsRoot : null)
      ? suspendedLanes
      : getNextLanes(
          root,
...
function attemptEarlyBailoutIfNoScheduledUpdate(
  ...
  switch (workInProgress.tag) {
    ...
    case 31:
      ...
      break;
    case 13:
      var state$67 = workInProgress.memoizedState;
      if (null !== state$67) {
        if (null !== state$67.dehydrated)
          return (
            pushPrimaryTreeSuspenseHandler(workInProgress),
            (workInProgress.flags |= 128),
            null
    ...
    case 19:
      ...
      state$67 = 0 !== (renderLanes & workInProgress.childLanes);
      state$67 ||
        (propagateParentContextChanges(
          current,
          workInProgress,
  ...
  if (didBailout)
    for (var child$72 = completedWork.child; null !== child$72; )
      (newChildLanes |= child$72.lanes | child$72.childLanes),
        (subtreeFlags |= child$72.subtreeFlags & 65011712),
        (subtreeFlags |= child$72.flags & 65011712),
    ...
    if (null !== lastEffect) {
      ...
      do {
        if ((updateQueue.tag & flags) === flags) {
          lastEffect = void 0;
          var create$95 = updateQueue.create,
            inst = updateQueue.inst;
          lastEffect = create$95();
  ...
  if (flags & 2) {
    try {
      ...
      switch (hostParentFiber.tag) {
        ...
        case 3:
        case 4:
          var parent$98 = hostParentFiber.stateNode.containerInfo,
...
function commitRootWhenReady(
  ...
  if (null !== finishedWork) {
    ...
    var remainingLanes = (didIncludeRenderPhaseUpdate |=
    ...
    root = 0 !== (finishedWork.flags & 13878);
    if (0 !== (finishedWork.subtreeFlags & 13878) || root) {
      root = ReactSharedInternals.T;
        ...
        for (nextEffect = finishedWork; null !== nextEffect; ) {
          ...
          if (0 !== (finishedWork.subtreeFlags & 1028) && null !== child)
            ...
            b: for (; null !== nextEffect; ) {
              finishedWork = nextEffect;
              lanes = void 0;
              spawnedLane = finishedWork;
              var current = spawnedLane.alternate,
                flags = spawnedLane.flags;
              switch (spawnedLane.tag) {
                case 0:
                  if (0 !== (flags & 4)) {
                    var updateQueue = spawnedLane.updateQueue,
                      eventPayloads =
                        null !== updateQueue ? updateQueue.events : null;
                    if (null !== eventPayloads)
                      for (lanes = 0; lanes < eventPayloads.length; lanes++) {
                ...
                case 1:
                  if (0 !== (flags & 1024) && null !== current) {
                    var prevProps = current.memoizedProps,
                      ...
                      instance = spawnedLane.stateNode;
                    try {
                      var resolvedPrevProps = resolveClassComponentProps(
                        spawnedLane.type,
                        prevProps
                      );
                      lanes = instance.getSnapshotBeforeUpdate(
                        resolvedPrevProps,
                        prevState
                      );
                      instance.__reactInternalSnapshotBeforeUpdate = lanes;
                    } catch (error) {
                      captureCommitPhaseError(
                        spawnedLane,
                        spawnedLane.return,
                ...
                case 3:
                  0 !== (flags & 1024) &&
                    spawnedLane.stateNode.containerInfo.children.splice(0);
                  break;
                case 5:
                case 26:
                case 27:
...
function flushPendingEffects() {
  ...
  flushLayoutEffects();
  flushSpawnedWork();
  a: if (5 !== pendingEffectsStatus) var JSCompiler_inline_result = !1;
  else {
    var root = pendingEffectsRoot,
