import type { ColorValue, NativeSyntheticEvent, StyleProp, TextStyle, ViewProps, ViewStyle } from 'react-native';
import type { PlatformIcon, PlatformIconIOS, UserInterfaceStyle, ScrollEdgeEffect } from '../../types';
export type EmptyObject = Record<string, never>;
export type TabsScreenEventHandler<T> = (event: NativeSyntheticEvent<T>) => void;
export type LifecycleStateChangeEvent = Readonly<{
    previousState: number;
    newState: number;
}>;
export type TabsScreenBlurEffect = 'none' | 'systemDefault' | 'extraLight' | 'light' | 'dark' | 'regular' | 'prominent' | 'systemUltraThinMaterial' | 'systemThinMaterial' | 'systemMaterial' | 'systemThickMaterial' | 'systemChromeMaterial' | 'systemUltraThinMaterialLight' | 'systemThinMaterialLight' | 'systemMaterialLight' | 'systemThickMaterialLight' | 'systemChromeMaterialLight' | 'systemUltraThinMaterialDark' | 'systemThinMaterialDark' | 'systemMaterialDark' | 'systemThickMaterialDark' | 'systemChromeMaterialDark';
export type TabsSystemItem = 'bookmarks' | 'contacts' | 'downloads' | 'favorites' | 'featured' | 'history' | 'more' | 'mostRecent' | 'mostViewed' | 'recents' | 'search' | 'topRated';
export type TabsScreenOrientation = 'inherit' | 'all' | 'allButUpsideDown' | 'portrait' | 'portraitUp' | 'portraitDown' | 'landscape' | 'landscapeLeft' | 'landscapeRight';
...
//# sourceMappingURL=TabsScreen.types.d.ts.map