...
import { NetInfoStateType, NetInfoCellularGeneration } from './types'; // See https://wicg.github.io/netinfo/#dom-connectiontype

// Check if the browser supports the connection API
const connection = window.navigator.connection || window.navigator.mozConnection || window.navigator.webkitConnection; // Map browser types to native types
