...
const Pressable = props => {
  ...
  const pressAndTouchGesture = (0, _react.useMemo)(() => _gestureObjects.GestureObjects.LongPress().minDuration(_reactNative.Platform.OS === 'web' ? 0 : _utils2.INT32_MAX) // Long press handles finalize on web, thus it must activate right away
