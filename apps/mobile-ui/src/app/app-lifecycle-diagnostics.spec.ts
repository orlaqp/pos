...
describe('app lifecycle diagnostics', () => {
    ...
    it('stores the previous session and writes a new session on startup', async () => {
        ...
        expect(mockedStorage.setItem).toHaveBeenCalledWith(
            'app-lifecycle-previous-session-v1',
            expect.stringContaining('"sessionId":"previous-session"')
        );
        expect(mockedStorage.setItem).toHaveBeenCalledWith(
