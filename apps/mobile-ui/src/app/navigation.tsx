        ...
        Alert.alert(
            ...
            [
                { text: t('COMMON_No', 'No') },
                {
                    ...
                    onPress: () => dispatch(cartActions.reset()),
                },
            ],
        );
    };
