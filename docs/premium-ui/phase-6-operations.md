...
- [~] Improve count and receive forms for dense data entry on iPad.
- [x] Improve line-item readability for inventory rows and transactional subrows.
- [ ] Standardize configuration forms in store, station, and printer areas.
- [ ] Improve logs/settings readability with better grouping and metadata treatment.
- [ ] Reuse earlier list/form/dialog patterns rather than reinventing operational UI.
